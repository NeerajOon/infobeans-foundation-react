        ...
        <div className="container">
          ...
          {gList.map((img,index)=><div className="col-lg-4 col-md-6 portfolio-wrap filter-app">
              <div className="portfolio-item">
                <img src={"/images/"+img.image} style={{minHeight:"200px",maxHeight:'200px',width:'100%'}} className="img-fluid" alt="" />
                <div className="portfolio-info">
                  <h3>{img.caption}</h3>
                  <p className='text-white'><b>{img.dateOfUpload}</b></p>
                  <div>
                    {/* <a href={"/images/"+img.image} data-gallery="portfolioGallery" className="portfolio-lightbox" title="App 1"><i className="bx bx-plus"></i></a> */}
                  </div>
                </div>
              </div>
            </div>)}
